...
Мы рекомендуем обновить систему \TeX\ до \texttt{texlive 2015} или свежее.
Или же обновить только пакет \pkg{fontenc} до
...
Например, если мы хотим чтобы все пометы печатались красным цветом, то достаточно поместить
