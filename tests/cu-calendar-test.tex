...
\def\cuDateAssertJulianTest#1#2{%
  \expandafter\cu@@formatJulianDate\number #1\relax
  \def\@y{#2}%
  \ifnum#2\else
    \errmessage{TEST FAILED: #1: assertion "#2" FAILED}%
  \fi
...
\cuDateAssertJulianTest{2016-2-29}{\cuINDICTION=6}
...
\cuDateAssertTest{2016-5-1}{\cuINDICTION=6}

\cuDateAssertTest{2000-3-13}{\cuYEARAM=7508}
\cuDateAssertTest{2000-3-14}{\cuYEARAM=7509}

\cuDateAssertTest{2010-5-1}{\cuINDICTION=15}
\cuDateAssertTest{2011-5-1}{\cuINDICTION=1}
